...
def main():
    ...
    savings_interest_rate = float(input("What is the interest rate?"))
    savings_months = int(input("For how many months?"))
    ...
    cd_interest_rate = float(input("What is the interest rate?"))
